...
@else
    <form action="{{ url('/kompen/' . $kompen->id_kompen . '/update_ajax') }}" method="POST" id="form-edit">
        @csrf
        @method('PUT')
        <div id="modal-master" class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input value="{{ $kompen->kode_jenis }}" type="text" name="kode_jenis" id="kode_jenis" class="form-control" required>
                        <small id="error-kode_jenis" class="error-text form-text text-danger"></small>
                    </div>
                    <div class="form-group">
                        <label></label>
                        <input value="{{ $kompen->nama_jenis }}" type="text" name="nama_jenis" id="nama_jenis" class="form-control"
                            required>
