...
@else
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <small id="error-kode_level" class="error-text form-text textdanger"></small>
                    </div>
                    <div class="form-group">
                        <label>Nama Level</label>
                        <input value="{{ $level->nama_level }}" type="text" name="nama_level" id="nama_level" class="form-control"
                            required>
    ...
    <script>
        $(document).ready(function() {
            $("#form-edit").validate({
                rules: {
                    kode_level: { required: true, minlength: 3, maxlength: 10 },
