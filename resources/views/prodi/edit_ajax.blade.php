            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <small id="error-kode_prodi" class="error-text form-text textdanger"></small>
                    </div>
                    <div class="form-group">
                        <label>Nama prodi</label>
                        <input value="{{ $prodi->nama_prodi }}" type="text" name="nama_prodi" id="nama_prodi" class="form-control"
                            required>
